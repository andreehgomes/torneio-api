...
import com.torneioapi.service.TemporadaService;
...
public class TemporadaResource {
	...
	@PutMapping("/{codigo}")
	public ResponseEntity<Temporada> atualizar(@PathVariable Long codigo, @Valid @RequestBody Temporada temporada){
		Temporada temporadaSalva = temporadaService.atualizar(codigo, temporada);
		return ResponseEntity.status(HttpStatus.OK).body(temporadaSalva);
	}
